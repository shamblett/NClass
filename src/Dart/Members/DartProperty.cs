...
{
    internal sealed class DartProperty : Property
    {
        ...
        /// </exception>
        internal DartProperty(CompositeType parent) : this("NewProperty", parent)
        {
        }
        ...
        /// <paramref name="parent"/> is null.
        /// </exception>
        internal DartProperty(string name, CompositeType parent) : base(name, parent)
        {
        }
        ...
        public override string Name
        {
            ...
            set
            {
                var declaration = DartPropertyNameDeclaration.Create(value);
        ...
        {
            InitFromDeclaration(DartPropertyDeclaration.Create(declaration));
        }
        ...
        {
            if (declaration is IDartPropertyDeclaration sharpDeclaration)
            {
        ...
        {
            DartProperty property = new DartProperty(newParent);
            property.CopyFrom(this);
            return property;
        }

        private void InitFromDeclaration(IDartPropertyDeclaration declaration)
        {
            RaiseChangedEvent = false;
            ...
            try {
                ...
                if ((declaration.Name != "this" || !HasParameter) &&
                    DartLanguage.Instance.IsForbiddenName(declaration.Name)) {
        ...
        private void InitFromNameDeclaration(DartPropertyNameDeclaration declaration)
        {
            RaiseChangedEvent = false;
