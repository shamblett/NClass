...
{
    internal sealed class DartDestructor : Destructor
    {
        ...
        /// </exception>
        internal DartDestructor(CompositeType parent) : base(parent)
        {
        ...
        {
            InitFromDeclaration(DartDestructorDeclaration.Create(declaration));
        }
            
        public override void InitFromDeclaration(IMethodDeclaration declaration)
        {
            if (declaration is IDartDestructorDeclaration DartDeclaration)
            {
        ...
        {
            return new DartDestructor(newParent);
        }

        private void InitFromDeclaration(IDartDestructorDeclaration declaration)
        {
