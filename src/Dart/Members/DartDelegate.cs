...
{
    internal sealed class DartDelegate : DelegateType
    {
        internal DartDelegate() : this("NewDelegate")
        {
        }
        ...
        /// </exception>
        internal DartDelegate(string name) : base(name)
        {
        }
        ...
        {
            DartDelegate newDelegate = new DartDelegate();
