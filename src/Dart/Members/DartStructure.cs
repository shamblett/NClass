...
{
    internal sealed class DartStructure : StructureType
    {
        internal DartStructure() : this("NewStruct")
        {
        }
        ...
        /// </exception>
        internal DartStructure(string name) : base(name)
        {
        }
        ...
        {
            DartStructure structure = new DartStructure();
