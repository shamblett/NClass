...
{
    internal sealed class DartEvent : Event
    {
        ...
        /// </exception>
        internal DartEvent(CompositeType parent) : this("NewEvent", parent)
        {
        }
        ...
        /// <paramref name="parent"/> is null.
        /// </exception>
        internal DartEvent(string name, CompositeType parent) : base(name, parent)
        {
        }
        ...
        public override string Name
        {
            ...
            set
            {
                var declaration = DartEventNameDeclaration.Create(value);
        ...
        {
            InitFromDeclaration(DartEventDeclaration.Create(declaration));
        }
        ...
        {
            if (declaration is IDartEventDeclaration sharpDeclaration)
            {
        ...
        {
            DartEvent newEvent = new DartEvent(newParent);
        ...
        private void InitFromDeclaration(IDartEventDeclaration declaration)
        {
            RaiseChangedEvent = false;
        ...
        private void InitFromNameDeclaration(DartEventNameDeclaration declaration)
        {
            RaiseChangedEvent = false;
